      ...
      <section className="py-24 px-6 flex flex-col items-center text-center">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <p className="text-xl text-muted-foreground">
            A modern full-stack template for building beautiful, accessible, and
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-background rounded-lg p-6 shadow-sm border">
              ...
              <p className="text-muted-foreground">
                React framework with App Router, Server Components, and Edge
                Runtime.
              </p>
            </div>
            ...
            <div className="bg-background rounded-lg p-6 shadow-sm border">
              ...
              <p className="text-muted-foreground">
                Open source Firebase alternative with auth, database, and
                storage.
              </p>
            </div>
          </div>
